export default ({
  ...
  teaches: `<p>Reading 1 left you with two extremes: assume nothing (historical simulation, HS) or assume everything (a full parametric distribution). This reading builds the middle ground, four upgrades that keep HS's assumption-free character while fixing its two structural flaws: every observation in the window gets equal weight regardless of age or regime, and you can only read Value at Risk (VaR) at the confidence levels your data happens to support.</p>
