export default ({
  ...
  highYield: [
    { stars: 3, what: "Jensen's inequality direction: E[1/(1+r)] > 1/(1+E[r]) → volatility lowers implied yield.", why: "The counter-intuitive direction, higher vol means lower yield, is exactly the direction a question will probe." },
  ...
  breakdown: [
    ...
    },
    {
      ...
      points: [
        "Flat: 1-year rate 8% today, expected 8% next year and 8% the year after → 1-, 2-, 3-year spot rates are all 8%, so investors are willing to lock in the same rate for any horizon.",
  ...
  quiz: [
    ...
    },
    {
      ...
      answer: 1,
      why: "At very long horizons, precise rate forecasts aren't credible, so the level of the long end is explained by anchoring assumptions (real rate + inflation) rather than a specific expected path. Convexity doesn't make expectations 'irrelevant' (the 'convexity dominates' answer, which wrongly claims expectations become irrelevant). It is an additive adjustment on top of whatever expectations imply."
    },
    {
