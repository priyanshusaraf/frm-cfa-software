export default ({
  ...
  concepts: [
    ...
    },
    {
      ...
      example: "Company B and C's 1-year cumulative default probabilities map to \\(N^{-1}(Q_B(t))\\) and \\(N^{-1}(Q_C(t))\\). With bivariate normal \\(M_{2}\\) and correlation \\(\\rho\\) (0.4, in the standard worked example of two non-investment-grade, junk-rated companies B and C), joint default probability reads off the bivariate normal CDF at those two points.",
  ...
  quiz: [
    ...
    },
    {
      ...
      answer: 1,
      why: "This is the reading's central 'why it fell out of favor' narrative: the failure was a structural blind spot in tail dependence, not a calibration or input-data error. Measuring the marginal default probability curves incorrectly is the classic tempting distractor since it sounds plausible, but the marginals were generally fine. The dependence structure was the problem."
    },
    {
