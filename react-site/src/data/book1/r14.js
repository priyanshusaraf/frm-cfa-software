export default ({
  ...
  concepts: [
    ...
    },
    {
      ...
      pitfall: "Don't confuse 'basis point volatility' (volatility of the level change dr) with 'yield volatility' (volatility of the percentage change). CIR has NEITHER constant. The lognormal model, by contrast, has CONSTANT yield volatility even though its basis-point volatility still increases with the rate level. This exact distinction has been directly tested.",
