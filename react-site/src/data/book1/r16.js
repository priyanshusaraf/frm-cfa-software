export default ({
  ...
  quiz: [
    ...
    },
    {
      ...
      answer: 1,
      why: "Credit spread risk moves continuously day to day and fits naturally into the same ES framework used for general market risk. Default, in contrast, is a discrete jump: the issuer either defaults or does not. FRTB therefore keeps it as a separate charge (99% VaR, one-year horizon) rather than blending it into the continuous ES calculation. The claim that jump-to-default risk is always smaller in dollar terms is wrong on the facts, since such losses can be severe. The 'irrelevant formality' and 'ES cannot be computed' choices misstate the framework. Both risks are taken seriously, and ES computation is not the obstacle."
    },
    {
