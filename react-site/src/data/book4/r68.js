export default ({
  ...
  concepts: [
    {
      ...
      def: "The two halves of a bank's cash position during the business day. USES are the outflows: outgoing wire transfers (the single biggest one), settlements at Payment Clearing and Settlement (PCS) systems, funding of nostro accounts, collateral pledging, and asset purchases. SOURCES are the inflows: cash balances, incoming funds flow (the single biggest one), intraday credit, liquid assets, overnight borrowings, and other term funding. Each is set out in the breakdown below, with how forecastable it is, because forecastability is what decides how much cushion the treasurer has to hold against it.",
    ...
    },
    {
      ...
      def: "The set of arrangements that makes intraday liquidity risk somebody's explicit job rather than a by-product of the payments operation. It rests on four pillars, listed in the breakdown below: active risk management, integration with the three lines of defense, risk assessment centred on settlement risk, and measurement of intraday credit both provided and used.",
      ...
      pitfall: "The three-lines-of-defense model reapplies here exactly as in general risk governance (see R41), but the EMPHASIS shifts to corporate risk management as the active second line, so do not assume treasury alone owns intraday liquidity risk just because treasury executes the payments.",
      related: [{ r: 41, label: "R41: the three lines of defense model reapplied here" }]
    },
    {
      name: "Tracking flows vs. monitoring risk levels",
      def: "Two different jobs that are easy to run together and should not be. TRACKING flows is raw bookkeeping: total payments, other cash transactions across financial market utilities (FMUs), settlement positions, time-sensitive obligations, and intraday credit lines both extended to clients and used by the bank. MONITORING risk levels turns those flows into signals: daily maximum intraday liquidity usage, intraday credit relative to Tier 1 capital, client intraday credit usage, and payment throughput. The breakdown below gives each one; the distinction that matters is that only the second of those four risk metrics reads the bank's contribution to SYSTEMIC risk.",
      example: "A bank's most negative balance on Tuesday was $80 million against a $100 million committed credit line, so daily maximum intraday liquidity usage = 80/100 = 80%. Separately, the bank has $30 million of unsecured, available (unused) intraday credit against $500 million of Tier 1 capital, so intraday credit / Tier 1 capital = 6%. The 80% figure says 'Tuesday was a stressful day for us personally'; the 6% figure says 'here is our standing contribution to payment-system-wide risk,' and it is the second number that reads as the systemic-risk measure.",
      pitfall: "The metric that specifically captures the bank's contribution to SYSTEMIC risk is intraday credit relative to Tier 1 capital, NOT daily maximum usage (about the bank's own exposure) or client usage (about client-specific risk). That three-way distinction is the one most worth having straight.",
      related: [],
  ...
  highYield: [
    { stars: 4, what: "The systemic-risk metric: intraday credit relative to Tier 1 capital, distinct from daily maximum usage and client usage.", why: "The central conceptual distinction here, and the one most likely to be tested by swapping one metric for another in the options." },
    { stars: 3, what: "Uses (biggest: outgoing wires) vs. sources (biggest: incoming funds; only costly source: intraday credit).", why: "A precise classification, which invites the question of which single item is the biggest use or the only costly source." },
    { stars: 2, what: "Four governance pillars, especially the three-lines-of-defense reapplication with corporate risk management emphasized.", why: "Builds directly on R41's governance framework, and the emphasis on the second line is the detail a question can turn on." }
  ],
  ...
  breakdown: [
    {
      ...
      points: [
        ...
        "Settlements at Payment Clearing and Settlement (PCS) systems: these often settle once daily near day's end; same-day settlement amounts are hard to forecast, multi-day ones easier.",
        ...
        "Asset purchases and funding: covers securities purchases, fixed-asset purchases, and client loans/credit-line draws; securities/fixed-asset purchases are easier to forecast than client loan draws."
      ]
    },
    {
      ...
      points: [
        ...
        "Intraday credit: a temporary overdraft from the central bank, zeroed out by day's end; the ONE source with a genuine explicit interest cost or collateral opportunity cost.",
        "Liquid assets: near-cash items such as money market instruments, time deposits, government securities maturing within one year.",
        ...
        "Other term funding: an extension of overnight borrowing out to a week or month; supplemental/occasional rather than routine."
      ]
    },
    {
      title: "Governance: the four pillars",
      points: [
        "Active risk management: treat intraday liquidity risk as proactively manageable rather than a passive given, with settlement risk and systemic risk named explicitly in the risk appetite statement.",
        "Integration with risk governance: duties run across the three lines of defense, treasury executing day-to-day cash management, corporate risk management (the line emphasized here) setting funding policy and producing firm-wide consolidated reporting, and internal audit reviewing independently. Senior personnel take part in key decisions, and oversight committees are staffed to balance treasury and IT expertise.",
        "Risk assessment: focused on settlement risk, where business units and the risk team judge how far internal controls can actually reduce it.",
        "Risk measurement and monitoring: tracked as two dollar figures, the intraday credit the bank PROVIDES to customers and the intraday credit the bank itself USES."
      ]
    },
    {
      title: "Tracking intraday flows",
      points: [
        "Total payments: amount, time, payer and payee for every electronic payment; rolls up into totals sent/received, net settlement position, volume trends.",
        "Other cash transactions: intraday and ending settlement positions across all FMUs the bank participates in.",
        "Settlement positions: the position with each FMU; deadlines and large amounts make trend-watching essential for anticipating liquidity needs.",
        ...
        "Total bank intraday credit lines available and used: the bank's own systemic-risk contribution, comparing normal usage to maximum available (committed + uncommitted) credit."
      ]
    },
    {
      ...
      points: [
        ...
        "Intraday credit relative to Tier 1 capital: the ratio of UNSECURED, AVAILABLE (not used) intraday credit to Tier 1 capital; the key SYSTEMIC-risk metric, since collateral pledging already reduces settlement risk.",
        ...
        "Payment throughput: the proportion of outgoing payments made by various points in the day; tracks patterns, ensures on-time-payment compliance with FMU rules, identifies peak strain periods."
      ]
    }
  ],
  ...
  quiz: [
    ...
    {
      q: "In the governance structure for intraday liquidity risk, which line of defense receives particular emphasis?",
