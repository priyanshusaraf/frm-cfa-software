export default ({
  ...
  concepts: [
    ...
    },
    {
      ...
      def: "Dealer banks run five main business lines, each of which creates a distinct channel through which counterparty exit accelerates a liquidity crisis: (1) OTC derivatives dealing in swaps, CDOs, CMOs and CDSs; (2) repo financing of the dealer's own balance sheet; (3) investment banking (underwriting, M&A advice, merchant banking in commodities); (4) prime brokerage for hedge funds; (5) traditional commercial banking (deposits, lending).",
    ...
    },
    {
      ...
      intuition: "This is the actual, final trigger of collapse, not the slow bleed of counterparties leaving, but the single moment a dealer bank literally cannot make a payment it owes that day. Once that happens, the dealer bank is in default on its settlement obligations, which forces a bankruptcy filing regardless of what its balance sheet says about long-run solvency.",
  ...
  thinkLike: `<p>During a stress episode a dealer bank's liquidity manager does not treat "are we solvent?" as the operative question. Solvency is slow to establish and needs a balance sheet nobody can verify in real time. By the time it is answered the bank may already be gone.</p>
  <p>The operative question is how fast the funding can disappear, and whether there is anything to bridge the gap.</p>
  <p>That reframing changes the job. Ladder the debt maturities so only a small slice needs refinancing on any given day. Hold bank lines and liquid securities as a buffer.</p>
  <p>And treat reputational signals as liquidity events rather than public-relations problems. A downgrade, a refused novation, a widening bid-ask spread: counterparties react to these mechanically and within hours, which makes them funding events whatever else they are.</p>
  <p>Two question shapes follow. "Least likely to accelerate a crisis" requires knowing the actual named channels (repo non-renewal, novation requests, prime brokerage flight, in-the-money options revised to at-the-money) against a plausible outsider. Retail depositor withdrawal is the standard trap, because a dealer bank's commercial arm is a small, separate channel from the wholesale mechanism that actually kills it.</p>
  <p>The other maps policy to problem: central clearing answers derivatives contagion, tri-party repo utilities and the Primary Dealer Credit Facility answer repo non-renewal, and TARP and PPIP answer adverse selection in fire sales. The trap is treating the 2008 responses as one interchangeable bucket.</p>`,
  breakdown: [
    {
      title: "Lines of business a dealer bank runs, and their liquidity risk",
      points: [
        "OTC derivatives dealing in swaps, CDOs, CMOs and CDSs: dealer banks run a 'matched book,' offsetting each client position with an opposite position against another dealer, so one dealer's trouble transmits directly to every other dealer it faces.",
    ...
    },
    {
      ...
      points: [
        ...
        "Ultimately, the clearing bank invokes its right of offset and withholds cash settlement, the final step that turns a liquidity strain into an actual default."
      ]
    },
    {
      ...
      points: [
        ...
        "Tri-party repo utilities, or 'emergency banks': proposed infrastructure with fewer conflicting incentives to manage orderly unwinds of a troubled dealer's repo book and set tighter standards for margin, documentation, and collateral substitution.",
