export default ({
  ...
  highYield: [
    { stars: 3, what: "Historical average cost (backward-looking) vs. pooled funds (forward-looking), which to use for new lending decisions.", why: "A precise distinction with a clear correct-use-case answer." },
