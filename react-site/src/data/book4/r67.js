export default ({
  ...
  concepts: [
    ...
    },
    {
      ...
      pitfall: "Liability management looks 'free' because you don't tie up a buffer of low-earning assets, but it exposes the bank to interest-rate volatility and credit-availability risk exactly when the bank most needs to borrow. That is why it counts as the riskier of the three strategies despite looking cheaper.",
      related: []
    },
    {
  ...
  misconceptions: [
    ...
    { wrong: "\"Liability management is the safer strategy because the bank never has to sell assets at a bad time.\"", right: "Liability management avoids forced asset sales, but it substitutes a different risk: exposure to interest-rate volatility and uncertain credit availability at exactly the moment the bank needs to borrow, which makes it the riskiest of the three strategies rather than the safest." }
  ],
  ...
  quiz: [
    ...
    {
      q: "In the structure-of-funds approach, why are different reserve percentages (e.g., 90%, 25%, 10%) applied to hot money, vulnerable funds, and core deposits, rather than one uniform percentage to total deposits?",
      options: [
