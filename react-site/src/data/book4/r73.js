export default ({
  ...
  quiz: [
    ...
    {
      q: "At which CFP escalation level does the firm's focus shift specifically to surviving and remaining a going concern, after significant liquidity-raising actions have already been taken?",
      options: [
        "Level 1",
        "Level 2",
        "Level 3",
