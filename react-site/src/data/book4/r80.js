export default ({
  ...
  concepts: [
    ...
    },
    {
      ...
      def: "Four routes to capturing the illiquidity premium, listed in the breakdown below in ascending order of how well they actually work: passive allocation to an illiquid asset class, liquidity security selection within a class, acting as a market maker, and dynamic factor strategies. The ordering is the content. The first route buys the asset-class premium, which the evidence says may not exist; the last buys the within-class premium, which it says does.",
  ...
  eli5: `<p>You own a vintage guitar worth about $10,000. You also have $10,000 sitting in a checking account. On paper you have $20,000.</p>
  <p>Your car breaks down and you need $2,000 by tomorrow. From the checking account that takes seconds, at exactly the price the statement says.</p>
  <p>The guitar is a different object. It is genuinely worth $10,000, but the collector who would pay that lives in another city and wants weeks to authenticate it. If you insist on selling today, you take $6,000 from whoever happens to be nearby and willing.</p>
  <p>Notice what did not happen there. The guitar did not lose value. What you discovered is that "a willing buyer, right now, at a fair price" is a much rarer thing than "a willing buyer, eventually, at a fair price", and the $4,000 is what that rarity costs.</p>
  <p>That gap is illiquidity risk, and Harvard's endowment met it in 2008. Its private-equity stakes were probably worth close to what the books said. It simply could not turn them into cash for payroll without accepting discounts near 50%.</p>
  <p>Which is the sentence worth keeping: only liquid assets can actually be eaten. A balance sheet tells you what you own, not what you can spend this week.</p>`,
  ...
  breakdown: [
    ...
    },
    {
      ...
      points: [
        ...
        "Dynamic factor strategies: long illiquid / short liquid at the portfolio level, rebalanced countercyclically; this is the easiest of the four to implement and likely to have the largest effect on portfolio returns."
      ]
    },
    {
  ...
  quiz: [
    ...
    {
      q: "Which of the four ways to harvest illiquidity premiums is the easiest to implement AND likely to have the largest effect on portfolio returns?",
      options: [
