export default ({
  ...
  highYield: [
    { stars: 3, what: "Five maturity strategies (ladder, front-end, back-end, barbell, rate expectations) and their trade-offs.", why: "A clean five-item classification, good for the 'which of these is X' question shape." },
