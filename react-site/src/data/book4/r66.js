export default ({
  ...
  formulas: [
    {
      ...
      <p>A municipal bond's coupon income is exempt from federal tax, so its after-tax yield equals its stated (gross) YTM. No adjustment needed. Worked example: a bank compares an AA-rated corporate bond with a 6% YTM against an AA-rated municipal bond with a 4.4% YTM, at a 35% marginal tax rate.</p>
  ...
  concepts: [
    {
      ...
      def: "Money market (≤1yr, low risk/yield): T-bills, short T-notes/bonds, federal agency securities, CDs, Eurocurrency deposits, bankers' acceptances, commercial paper, short-term municipal obligations. Capital market (>1yr, higher risk/yield): Treasury notes/bonds, municipal notes/bonds, corporate notes/bonds.",
      ...
      example: "T-bills: zero-coupon, issued at a discount by the U.S. Treasury via weekly/monthly auctions, mature at par, priced using the bank discount method. They are the safest and most liquid instrument in the book because they carry the full faith, credit, and taxing power of the federal government, but that safety is why their yield is also the lowest. Federal agency securities (Fannie Mae, Freddie Mac, the Farm Credit System, Federal Land Banks) are not directly guaranteed by the government, but carry an implied guarantee (the market assumes Congress would bail them out), so they pay a bit more than Treasuries for a sliver of extra risk. CDs (certificates of deposit) are bank-issued time deposits (as small as $500 for consumer CDs, over $100,000 for business-oriented CDs) carrying FDIC insurance up to $250,000. Eurocurrency deposits are uninsured 30/60/90-day time deposits issued by large banks, concentrated in the London market, offering a yield pickup over domestic deposits but with taxable income and rate volatility. Bankers' acceptances are trade-finance instruments: a bank guarantees an importer/exporter's payment for a fee and becomes the primary obligor; to be Fed-eligible they must be denominated in U.S. dollars, have six months or less to maturity, and relate to actual goods trade or storage of marketable securities. Commercial paper is short-term (typically 90 days or less in the U.S.) unsecured discount paper issued by large corporations, popular with money market funds. Short-term municipal notes split into tax-anticipation notes (TANs, repaid from expected future tax revenue) and revenue-anticipation notes (RANs, repaid from a specific revenue-generating project like a toll road). Both are exempt from federal income tax, though state/municipal fiscal stress in recent years has dented their appeal.",
    ...
    },
    {
      ...
      example: "Worked ladder example: a bank with a 5-year maximum maturity puts 20% of its investable funds into each of the 1-, 2-, 3-, 4-, and 5-year buckets. A worked front-end example: a firm invests 100% of available (non-loan, non-reserve) funds into securities of two years or less, which maximizes liquidity at the cost of yield. A worked back-end example: a firm invests 100% into the 7 to 10 year range for a higher yield, though the firm may then need to borrow to cover near-term liquidity gaps since nothing frees up soon. Yield curve tools: a downward-sloping curve signals expected rate declines; the carry trade borrows short/cheap (at the low short-term rate) to invest long/rich (in a higher-yielding longer security), earning the 'carry return' as long as the investment yield net of borrowing cost and fees stays positive; riding the yield curve sells a bond after its price has spiked shortly before maturity (which happens under a steeply upward-sloping curve) and reinvests the proceeds into new longer-term securities, working as long as the curve's shape doesn't change.",
  ...
  misconceptions: [
    { wrong: "\"Large banks and small banks tend to hold similarly risky securities portfolios.\"", right: "Small banks skew toward SAFER government securities (offsetting riskier loan books); large banks tolerate MORE risk for yield (foreign securities, private debt, equity). Portfolio risk appetite tracks bank size, and it does so in one specific direction." },
    { wrong: "\"A ladder maturity strategy maximizes income compared to other strategies.\"", right: "Ladder is simple and provides steady cash flow, but it is explicitly NOT income-maximizing. Other strategies, such as rate-expectations positioning, aim for higher income at the cost of more risk/complexity." },
  ...
  highYield: [
    { stars: 3, what: "Five maturity strategies (ladder, front-end, back-end, barbell, rate expectations) and their trade-offs.", why: "Five names with five distinct shapes on the maturity line, which is exactly the kind of set a stem can describe and ask you to identify." },
    { stars: 3, what: "After-tax yield, tax-equivalent yield, and bank-qualified-bond net-after-tax-return calculations.", why: "The one calculation-heavy corner of an otherwise conceptual reading, and the numbers are small enough to be asked for outright." },
    { stars: 2, what: "Money market vs capital market instrument classification.", why: "Foundational vocabulary, straightforward recall." },
    { stars: 2, what: "Small vs large bank securities portfolio risk appetite.", why: "A directional fact, which means the wrong answer is simply the same claim reversed." },
    { stars: 2, what: "The nine investment-security selection factors (return, tax, six risk types, pledging).", why: "Broad conceptual coverage, and any one of the nine can be the subject of a stem asking which factor a described situation illustrates." }
  ],
  ...
  hooks: [
    { title: "Both ends, skip the middle", text: "A barbell strategy is exactly what it sounds like: weight sits at the short end and the long end, with nothing in between: a barbell's weights, not its bar." },
    { title: "The crossroads account", text: "The investment portfolio's nickname says what it does: it sits at the crossroads of borrowing and lending. Sell securities when cash is low, buy them when cash is high." }
  ],
  ...
  breakdown: [
    {
      ...
      points: [
        ...
        "Federal agency securities (Fannie Mae, Freddie Mac, Farm Credit System, Federal Land Banks): implied rather than direct government backing, higher yield than Treasuries, interest fully taxable.",
        "Certificates of deposit (CDs): bank-issued time deposits, FDIC-insured up to $250,000, consumer ($500 to $100,000) vs business (over $100,000) denominations.",
        ...
        "Bankers' acceptances: bank-guaranteed trade-finance paper, a discount instrument, Fed-eligible if USD-denominated, six months or less, and tied to actual goods trade.",
        "Commercial paper: unsecured discount paper from large corporations, typically 90 days or less, taxable income.",
    ...
    },
    {
      ...
      points: [
        "Treasury notes/bonds: coupon-bearing, full federal government backing, safety plus liquidity plus collateral value, but price risk from volatility.",
        ...
        "Corporate notes/bonds: notes up to 5yr, bonds over 5yr at issuance; higher yields than government debt but yield spreads widen in downturns; attractive to insurers and pension funds."
      ]
    },
    {
      title: "Newer/structured instruments",
      points: [
        "Structured notes: built from pools of agency securities, can carry cap/floor rates or step-up coupons; higher yield, higher complexity and loss potential.",
        ...
        "Real estate mortgage conduits (REMICs): segment mortgage cash flows into maturity classes; the main risk is prepayment risk.",
        "Mortgage-backed bonds (MBBs): the mortgages stay on the issuer's own balance sheet (segregated, trustee-monitored), unlike pass-throughs and CMOs.",
    ...
    },
    {
      ...
      points: [
        ...
        "Credit risk: the risk of missed payments or default, tracked via credit ratings (investment grade = BBB/Baa or better).",
        ...
        "Call risk: the issuer repurchases a callable bond when rates fall, forcing reinvestment at a lower rate.",
    ...
    },
    {
      ...
      points: [
        "Ladder (spaced-maturity): equal weight across every maturity bucket up to a cap (e.g., 20% each in the 1 through 5 year buckets); simple, steady liquidity, not income-maximizing.",
        "Front-end load: concentrate in short-term securities (e.g., 100% in two years or less); maximizes liquidity, minimizes yield.",
        "Back-end load: concentrate in long-term securities (e.g., 100% in the 7 to 10 year range); higher yield, may require borrowing to cover near-term needs.",
        ...
        "Rate expectations: actively shorten maturities when expecting rate rises, lengthen when expecting rate falls; requires sophisticated forecasting, suits larger institutions, and trades can trigger taxable gains or losses."
      ]
    },
    {
      title: "Maturity management tools",
      points: [
        "Yield curve: its shape signals rate expectations (downward-sloping = expected rate declines); enables the carry trade (borrow short/cheap, invest long/rich) and riding the yield curve (sell after a pre-maturity price spike, reinvest longer).",
        "Duration: the present-value-weighted average time to receive all cash flows; measures price sensitivity to rate changes; matching duration to the planned holding period immunizes the portfolio by offsetting price risk against reinvestment risk."
      ]
    }
  ],
  ...
  quiz: [
    ...
    },
    {
      ...
      answer: 1,
      why: "Investment grade stops at BBB/Baa, so falling from BBB to BB is the one downgrade here that crosses the line and forces a sale. A downgrade within the investment-grade band changes nothing for an investor under this restriction. The two downgrades that move from one speculative rating to a lower one are already below the line, so the security should have been sold before either happened, and no new forced sale is triggered."
    },
    {
