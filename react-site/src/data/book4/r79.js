export default ({
  ...
  <p>Two distinct kinds of interest-rate risk threaten this borrow-short-lend-long business. <strong>Reinvestment risk</strong> bites when a loan or security matures or reprices: the bank does not know in advance what rate it will earn, or pay, on the next round, so if rates have fallen it must reinvest at a lower yield. <strong>Price risk</strong> (also called market risk) bites in the other direction. When market rates rise, the present value of the bank's existing fixed-rate assets and liabilities falls, because those fixed coupon and payment streams are now worth less once discounted at a higher rate. IS gap analysis is built to manage the NII side of this problem (closely related to reinvestment risk); duration gap analysis is built to manage the net-worth side (price risk).</p>
  ...
  highYield: [
    ...
    { stars: 5, what: "Leverage-adjusted duration gap formula and why D_A=D_L does NOT insulate net worth.", why: "The most important conceptual correction in this reading. A frequently tested trap." },
    { stars: 5, what: "The 'opposite-direction' trap: negative IS gap + positive duration gap simultaneously, both correct.", why: "The central trap: the two gaps measure different things, so a bank can be liability sensitive on income and still lose net worth when rates rise." },
    { stars: 4, what: "Duration gap sign and net worth effect (zero/positive/negative cases).", why: "A clean three-case table, and the sign is what a stem turns on." },
