export default ({
  ...
  concepts: [
    ...
    },
    {
      ...
      def: "An economic balance sheet restates every position, including off-balance-sheet derivatives, at its cash-equivalent market value (delta-adjusted where the instrument is nonlinear), so that leverage can be measured consistently across margin loans, short sales, and derivatives rather than only across what the accounting balance sheet happens to show.",
