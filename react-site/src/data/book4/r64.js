export default ({
  ...
  eli5: `<p>You have $100 and you want a $200 boat. You put in your $100, borrow the other $100 from a friend, and now you control a $200 asset on $100 of your own skin. Total assets divided by your own stake is 2.0, and that number is the leverage ratio.</p>
  <p>Watch what it does. The boat gains 10% and you are up $20 on your $100, a 20% return. The boat loses 10% and you are down $20, a 20% loss. The borrowing did not create anything. It made your own money twice as sensitive to the boat, in both directions.</p>
  <p>Now change exactly one thing: you do not own a boat at all. You promise a friend you will hand him back a boat next month, borrow his today, and sell it immediately for $100 cash. You have shorted the boat.</p>
  <p>The consequences arrive on their own. That $100 of sale proceeds is not yours to spend; it sits as collateral, because you may have to buy the boat back for more than you sold it. On top of that you post $50 of your own money as a cushion. Your balance sheet now carries $150 of assets against a $100 liability, the boat you owe, on $50 of equity.</p>
  <p>Tally it properly and you are running $200 of assets against $100 of equity: the same 2.0 you had when you bought the boat outright with a loan. The difference is that you never chose it. Buying a boat, you picked how much to borrow. Shorting one, the trade required you to borrow the full value of the asset just to exist, and the leverage came attached.</p>
  <p>That is the distinction worth carrying out of the analogy. Buying $150 of stock with a $50 margin loan is leverage you selected. A short position's leverage is structural, which is why a rule that caps borrowing does not automatically cap it.</p>`,
  thinkLike: `<p>A risk manager building an "economic balance sheet" is asking one question over and over: <em>how much is this firm's fate riding on borrowed money, once every position (including the ones that don't show up on a standard accounting balance sheet) is converted into its cash-equivalent exposure?</em> A plain-vanilla long stock position and a short sale can look similarly sized in dollar terms but carry structurally different leverage: the long position's leverage is a dial the investor turns (how much margin to use), while the short position's leverage is fixed by the mechanics of borrowing and selling the full value of the stock. A derivatives book is the hardest case: a futures or forward contract is linear (zero NPV at initiation, so its economic-balance-sheet value is simply the notional of the underlying), but an option is nonlinear, its exposure changes as the underlying price moves. So a risk manager represents it at its delta-equivalent value (a 50-delta option is treated as a $50 position, financed the same way a $50 margin loan would be), not its full notional. The question to expect is whether you can (1) tell transactions liquidity risk (the market moving against you as you trade) apart from funding liquidity risk (your creditors turning on you), (2) recognize that they feed each other in a loop rather than existing independently, (3) build an economic balance sheet from a word problem (margin loan vs. short sale vs. option) and read off the resulting leverage ratio, and (4) know that gross leverage (counting every asset including short-sale proceeds) overstates true risk when a short position is actually a hedge, in which case net leverage (longs minus shorts, over capital) is the more honest number.</p>`,
  ...
  concepts: [
    ...
    },
    {
      ...
      def: "Banks take in $100 of deposits, hold a fraction ($10) for redemptions, lend the rest ($90), asset-liability management (ALM), works because deposits are 'sticky.' When withdrawals run past the reserve, the bank hits a suspension of convertibility: it cannot do the one thing depositors assume it can always do, turn a deposit into cash on demand. In the extreme that becomes a run on the bank, where depositors race each other to get out first, because whoever is at the back of the queue is the one left with nothing. Rollover risk on other short-term funding is a milder version of the same fragility, and higher capital reduces it.",
    ...
    },
    {
      ...
      def: "An economic balance sheet restates every position, including off-balance-sheet derivatives, at its cash-equivalent market value (delta-adjusted where the instrument is nonlinear), so that leverage can be measured consistently across margin loans, short sales, and derivatives rather than only across what the accounting balance sheet happens to show. The implicit leverage it exposes goes by a second name you should expect to see: embedded leverage. Buying stock on margin or issuing bonds is leverage taken on explicitly; the leverage inside a short position, an option or a swap is embedded in the instrument, and the economic balance sheet is the tool that makes it visible.",
  ...
  breakdown: [
    {
      title: "Reading leverage off an economic balance sheet: two worked cases",
      points: [
        "Margin loan: owners start with $100 of their own cash, use $50 of it plus a $50 margin loan to buy $100 of stock, and keep $50 in cash. The economic balance sheet shows $100 of stock plus $50 of cash against the original $100 of equity, so leverage is 150/100 = 1.5.",
        "Short sale: the firm borrows $100 of stock and sells it, and the $100 of proceeds must sit as restricted collateral rather than being spent. Add $50 of posted margin and the balance sheet shows $150 of restricted cash and margin against a $100 short-stock liability, so total assets of $200 over $100 of equity gives leverage of 2.0.",
        "The point of both: the accounting balance sheet would understate each position, because the borrowed stock and the derivative exposure never appear there at full economic size."
      ]
    },
    {
      title: "Collateral-market transaction types",
      points: [
        "Margin loans: collateralized by the security itself, usually extended by the broker executing the trade; the broker holds the stock in a 'street name' account (registered in the broker's name, not the customer's), which lets the broker both seize/sell it quickly on a margin call AND re-lend it to other customers who want to short it. Regulation T sets the minimum initial margin at 50%. Cross-margin agreements net an investor's long and short positions across accounts, transferring excess margin in one account to another that is short of it, so the investor posts less margin overall than the accounts would demand separately.",
  ...
  quiz: [
    ...
    },
    {
      ...
      answer: 0,
      why: "Regulation T requires a minimum of 50% equity (h=0.5). So a $200,000 position needs $100,000 of the investor's own equity and a $100,000 margin loan; leverage ratio = 1/h = 1/0.5 = 2.0. A $200,000 loan doubles the borrowing by ignoring the equity the investor must put up; the answers showing a leverage ratio of 1.0 describe an unlevered position, which is not what buying on margin produces."
    },
    {
