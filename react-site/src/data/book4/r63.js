export default ({
  ...
  visual: `<div class="widget" data-widget="balancesheet" data-bs='{"assets":[{"label":"House","amount":500000,"liquid":false},{"label":"Cash","amount":200,"liquid":true}],"liabilities":[{"label":"Bill due tomorrow","amount":5000,"nearTerm":true}]}'></div><div class="widget" data-widget="lvar"></div>`,
  ...
  concepts: [
    ...
    },
    {
      ...
      def: "Six places a firm can raise cash, and every one of them is worse than it looks. Cash and treasuries are safe but give up return. Retail and wholesale deposits are widely assumed stable and are not, because customers rate-shop across institutions and stress hits the whole deposit market at once rather than one bank. Trading book liquidation and securitization both fail exactly when they are needed, in stressed markets. Borrowing ability reprices against you at the worst moment. Central bank borrowing works but is expensive and signals distress.",
      pitfall: "Retail/wholesale deposits are frequently assumed to be a 'stable' funding source because they're insured or long-relationship, in practice they have become LESS stable over time, because moving money between banks in search of a higher rate now costs a depositor almost nothing. Two consequences follow: the funds most likely to leave are the ones chasing yield, and because every bank faces the same rate-shopping depositors, a tightening in liquidity conditions pulls at the whole deposit market at once rather than at one bank in isolation.",
      related: [],
    ...
    },
    {
      ...
      def: "Northern Rock (2007), Ashanti Goldfields (1999), and Metallgesellschaft, three firms whose positions were defensible and whose cash timing was not. Each held something economically sound (a mortgage book, a gold hedge, a supply-contract hedge) and each was broken by an obligation that came due in cash immediately: a deposit run, a margin call on the liquid leg of a hedge whose illiquid leg had gained, and a margin drain on near-dated futures hedging long-dated contracts.",
