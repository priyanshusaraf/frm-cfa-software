export default ({
  ...
  teaches: `<p>This reading gives you the vocabulary and machinery a bank actually uses to answer one question: <strong>"If things go badly, do we have enough cash to survive?"</strong> Every dollar of a bank's liquidity splits into four categories (<strong>operational, contingent, strategic, and restricted</strong>), because not all "liquid" money is available for the same purpose, and confusing them is exactly how a firm overstates its own resilience. On top of that sits the <strong>stressed liquidity asset buffer</strong>, a sufficiency check that starts with what you hold, subtracts what a crisis would force out the door, and adds what would still come in. The <strong>six design dimensions</strong> (scope, scenario development, assumptions, outputs, governance, and integration with other models) are what separate a stress test that genuinely protects a bank from one that is just a compliance exercise on a slide deck.</p>`,
  ...
  <p>Two very different kinds of question come out of this material. One is pure calculation: give you a normal buffer, a list of outflows and inflows, and ask you to compute the stressed buffer correctly. The trap is usually miscategorizing an item (is a facility draw an inflow or does it reduce future capacity? it is booked as an inflow now, even though it also uses up the facility). The other is classification: a stem describes a pool of money with a specific fixed purpose (an escrow account, posted collateral, funds committed to an acquisition) and asks which of the four liquidity categories it belongs to. The perennial trap is conflating "liquid" with "available," which is exactly the restricted-vs-contingent distinction this reading is built around.</p>`,
  ...
  formulas: [
    {
      ...
      derivation: `<p>Take the Firm A example, worked step by step:</p>
  ...
  concepts: [
    ...
    },
    {
      ...
      def: "The six choices that decide whether a liquidity stress test protects the bank or just satisfies a regulator: scope, scenario development, assumptions, outputs, governance, and integration with the firm's other models. Each is set out in the breakdown below. They form a pipeline rather than a checklist, so a weak choice early (a scope that ignores liquidity legally trapped in a foreign subsidiary, say) cannot be repaired by rigour later.",
  ...
  highYield: [
    { stars: 4, what: "Four funding liquidity categories (operational, contingent, strategic, restricted) and their distinct availability.", why: "A precise four-way split, and a stem can describe any pool of money and ask which category it falls into." },
