export default ({
  ...
  concepts: [
    ...
    },
    {
      ...
      pitfall: "Investment-grade marginal PD tends to RISE in early years (stable-looking issuers can deteriorate); low-grade (junk) marginal PD tends to FALL after early years (survivors of the risky early period are self-selected as sturdier). This directional asymmetry is a classic trap if you assume marginal PD always behaves the same way. Concretely, the source's B-rated example shows marginal PDs of 3.34%, 4.46%, 3.95%, 3.24% in Years 1 to 4, rising then falling, because the initial years are when the weakest junk names get shaken out.",
    ...
    },
    {
      ...
      example: "Moody's data across 1983 to 2021 shows more senior claims recover more: first-lien bonds average 54.6% recovery versus subordinated bonds averaging 32.1%, because seniority determines who gets paid first out of the same shrunken pool of recoverable assets.",
    ...
    },
    {
      ...
      related: [{ r: 29, label: "R29: the guidance table on which PD to use where" }, { r: 21, label: "R21" }],
  ...
  highYield: [
    ...
    { stars: 4, what: "CDS-bond basis: the named frictions and their direction.", why: "A precise list-based question format that recurs: know the list, not just 'frictions exist.'" },
  ...
  thinkLike: `<p>A credit risk manager hears "what is the PD?" and immediately attaches a follow-up question: PD <em>for what purpose</em>?</p>
  <p>If you are pricing a bond, a CDS or a loan today, you reach for a risk-neutral PD, backed out of spreads or out of Merton. That is the number consistent with what the market will actually pay or charge. Dropping a lower, "friendlier" real-world PD into a pricing calculation would systematically underprice the risk you are taking on.</p>
  <p>If you are running a stress test or deciding how much regulatory capital to hold against a loan book, you reach for a real-world PD from historical migration data. Here you want the honest empirical frequency of default. A risk-neutral number would be inflated by a market risk premium that says nothing about how often the bad outcome actually occurs.</p>
  <p>On the exam, this reading shows up in three recognizable shapes. The first is straight arithmetic: a hazard rate from a spread, a marginal PD out of a migration matrix, or a full Merton solve. Fluency with the calculation is what gets tested, not just the concept.</p>
  <p>The second asks which PD, or which model, fits a stated purpose. The trap is the mathematically correct-looking number attached to the wrong use case.</p>
  <p>The third asks you to name a friction in the CDS-bond basis and say which way it pushes. Knowing that frictions exist scores zero here: you need the specific list and each one's direction.</p>`,
