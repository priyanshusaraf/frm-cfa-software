export default ({
  ...
  concepts: [
    ...
    },
    {
      ...
      pitfall: "Don't assume social lending platforms have equally mature risk models to banks. This is explicitly flagged as an emerging, less-understood risk channel with historically higher default rates."
    },
    {
    ...
    },
    {
      ...
      def: "Rating agencies run an issuer through analyst review, a rating committee vote, and periodic surveillance, then publish a letter grade the whole market prices off. Five criticisms recur: opaque proprietary methodology, the issuer-pays conflict of interest, ratings that lag a fast-moving credit, outright predictive failures (Enron, WorldCom, the 2008 structured products), and procyclicality.",
