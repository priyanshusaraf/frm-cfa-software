export default ({
  ...
  breakdown: [
    ...
    },
    {
      ...
      points: [
        ...
        "Accessible: easy to find, ideally summarized in a 1 to 2 page document on the company intranet, not buried in a legal repository."
      ]
    }
  ],
  ...
  misconceptions: [
    ...
    { wrong: "\"Internal audit's job is to monitor risk-taking in real time, like risk management does.\"", right: "Internal audit (3rd line) provides independent assurance AFTER the fact that lines 1 and 2 are functioning, it doesn't do real-time monitoring, which is the 2nd line's job." },
  ...
  highYield: [
    { stars: 4, what: "Three lines of defense: the exact role of each line.", why: "The favorite governance framework of exam writers, reused across multiple FRM topics beyond credit risk." },
