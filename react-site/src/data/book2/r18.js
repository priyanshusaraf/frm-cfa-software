export default ({
  ...
  teaches: `<p>The three lines of defense is the organizing skeleton of this entire reading — memorize it cold, because it is GARP's favorite governance framework across multiple FRM topics, not just credit risk. You also learn the four GSLO pillars of good governance (Guidelines, Skills, Limits, Oversight), the three processes that actually generate credit risk in the first place (origination, assessment, approval), the three parameters that describe any credit-sensitive transaction (exposure amount, credit quality, tenor), and the role of the credit committee that approves the biggest, riskiest deals.</p>`,

  why: `<p>Every risk framework in the curriculum — credit, market, operational — eventually asks "who's accountable, and who checks them?" Getting this organizational skeleton right here means you recognize it instantly when it resurfaces in operational risk governance (Book 3) and model risk management. It also matters in the real world: nearly every major bank blow-up in history (Barings, JPMorgan's "London Whale," Wells Fargo's fake-accounts scandal) traces back to one of these lines failing — a risk manager who was really a business partner in disguise, an audit function that never actually checked, or guidelines so vague nobody could be held to them.</p>`,

  intuition: `<p>Think of a bank's risk governance as a court system. The <strong>business owners (1st line)</strong> are the ones taking action — originating loans, pricing trades, deciding who to lend to. <strong>Risk management/compliance (2nd line)</strong> is the judge watching for rule violations in real time — setting the limits, checking every deal against them before and while it happens. <strong>Internal audit (3rd line)</strong> is the appeals court: it shows up after the fact and checks whether the judge and the actors both did their jobs properly, independent of both. The reason this three-way split exists at all is a simple conflict-of-interest problem: the people who are paid to originate business (1st line) have every incentive to say yes to more, bigger, riskier deals, so you cannot let them also be the ones deciding whether those deals are safe. Someone independent of the P&L has to hold the line — that is the entire reason the 2nd line exists as a separate reporting chain from the business.</p>`,

  eli5: `<div><p>Imagine a restaurant kitchen. The <strong>line cooks (1st line)</strong> want to get orders out fast — that is their whole job, and their bonus depends on how many tables turn over. If they were also in charge of food-safety inspection, they would rush past a undercooked chicken breast to keep the line moving. So the restaurant has a separate <strong>health inspector (2nd line)</strong> who checks temperatures in real time, has the authority to send a dish back, and — crucially — gets paid a flat salary that has nothing to do with how many meals go out the door, so they have no incentive to look the other way. Once a month, a <strong>corporate auditor (3rd line)</strong> who doesn't even work at this restaurant shows up, reviews the inspector's logs, samples some dishes, and checks whether the inspector has actually been doing the job — not cooking, not inspecting food in the moment, just verifying the whole system worked. Mapped to finance: the line cooks are the bank's business owners who originate and price credit deals, the health inspector is risk management setting and monitoring limits with pay delinked from the desk's profits, and the corporate auditor is internal audit providing independent after-the-fact assurance.</p></div>`,
