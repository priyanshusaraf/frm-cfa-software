export default ({
  ...
  concepts: [
    {
      ...
      def: "The family of products built by pooling loans and selling claims on the pool, ordered by how far each one goes. Covered bonds barely qualify (the pool never leaves the originator's balance sheet). Pass-through securities move the pool off balance sheet but slice nothing. CMOs slice, but they slice PREPAYMENT timing. Structured credit products slice CREDIT losses instead, which is a completely different risk axis wearing the same word, tranche. Asset-backed securities is the umbrella term over all of it.",
    ...
    },
    {
      ...
      def: "In the three-tiered structure the exam works with (senior, mezzanine, equity), cash flows to senior first, then junior/mezzanine, then equity, with an overcollateralization (OC) trigger that can divert cash away from equity if coverage tests fail. The OC account and the excess spread feeding it are INTERNAL credit enhancements: protection built out of the deal's own cash flows rather than bought from a third party.",
  ...
  highYield: [
    { stars: 5, what: "The PD-vs-correlation comparative statics grid: especially correlation's OPPOSITE effect on senior vs equity.", why: "The single most heavily tested concept here, and the crux of the whole chapter." },
