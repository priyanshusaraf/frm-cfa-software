export default ({
  ...
  concepts: [
    ...
    },
    {
      ...
      pitfall: "High-yield bonds are the ONE asset class shown to be roughly indifferent to the economic growth cycle. The one exception to the 'stocks up in growth, bonds up in recession' pattern.",
      related: [],
  ...
  breakdown: [
    ...
    },
    {
      ...
      points: [
        ...
        "Productivity shocks: these hit firm output directly. Falling productivity means falling stock prices (the 1960s and 1970s); rising productivity means rising ones (the computer revolution of the 1980s and 1990s). The correlation between productivity shocks and stock returns runs around 50%, which is high. Dynamic stochastic general equilibrium (DSGE) models formalize this; the Smets and Wouters (2007) benchmark specifies seven shocks driving the business cycle: productivity, investment, preferences, inflation, monetary policy, government spending, and labor supply.",
        "Demographic risk: read it as a shock to labor output, so another shock to firm production. Overlapping generation (OLG) models carry it explicitly, with young and middle-aged workers saving while retirees disinvest. Anything that shocks the composition of a cohort (the World Wars, the COVID-19 pandemic, the post-war baby boom) moves returns, and one model predicts stock prices fall as baby boomers retire and liquidate assets, unless enough younger investors are buying on the other side. A separate finding: risk aversion rises with age, so an ageing population should carry a higher equity risk premium. Demographic studies need cross-country data to be worth anything.",
        "Political (or sovereign) risk: it raises risk premiums, and it is not an emerging-market problem. The 2007 to 2009 financial crisis made clear that political risk prices into developed markets too.",
      ]
    },
    {
  ...
  quiz: [
    ...
    {
      q: "Which asset class's returns are relatively indifferent to whether the economy is in expansion or recession?",
