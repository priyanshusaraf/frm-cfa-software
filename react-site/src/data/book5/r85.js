export default ({
  ...
  highYield: [
    ...
    { stars: 4, what: "Component VaR formula and the property that components sum exactly to total VaR.", why: "A clean decomposition whose components sum exactly to total VaR, which makes it easy to check and easy to ask for." },
