export default ({
  ...
  concepts: [
    ...
    },
    {
      ...
      def: "The strategy labels a hedge fund sells itself under, each naming a distinct source of return and, more usefully, a distinct way of losing money. The full roster is in the breakdown below. The organizing split worth carrying: trend-following strategies (managed futures, global macro) are typically HELPED by extreme moves, while event-driven ones (merger arbitrage, distressed securities) have nonlinear payoffs that turn against them precisely when markets move hardest.",
  ...
  highYield: [
    ...
    { stars: 4, what: "Risk-sharing asymmetry: the incentive fee structure's principal-agent problem and the personal-capital mitigant.", why: "A precise structure. Frequently tested governance/incentive concept." },
