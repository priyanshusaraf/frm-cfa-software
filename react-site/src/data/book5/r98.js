export default ({
  ...
  why: `<p>Every other climate reading (R97, and the disclosure/scenario material elsewhere) assumes measurement is possible. This reading is the reality check: climate risk measurement is still in its infancy, existing models systematically understate tail/extreme-event severity, and there is no common accounting standard for climate data. This is a taxonomy-heavy reading, so expect stems that describe an approach and ask which it is (top-down vs bottom-up, gross vs net exposure, IAM vs ABM vs CGE), alongside 'which of the following is NOT a challenge' questions.</p>`,
  ...
  highYield: [
    ...
    { stars: 3, what: "Stress testing is a FORM of scenario analysis.", why: "Not a separate category, which makes it a natural 'most accurate statement' item." },
  ...
  quiz: [
    ...
    {
      q: "Which of the following is NOT one of the three primary areas of uncertainty in climate risk measurement?",
      options: [
    ...
    },
    {
      ...
      answer: 1,
      why: "IAMs link emissions/transition drivers to economic growth by combining economic, energy, and climate modeling, but they explicitly flags that they have NOT captured extreme-weather economic impacts and tend to understate future severity. A named, testable weakness. Describing them as fully comprehensive or as eliminating uncertainty inverts this stated limitation."
    },
    {
