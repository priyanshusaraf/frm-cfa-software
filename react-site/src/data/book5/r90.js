export default ({
  ...
  eli5: `<p>A friend asks you to put your savings into his business. He drives a nice car and he pays great returns, he says. What would a sensible relative tell you to do before writing the cheque?</p>
  <p>Not admire the car. The car is a track record, and a track record is a claim about the past made by the person asking for your money.</p>
  <p>Go and see the shop. Not the numbers about the shop, the shop: who works there, whether the till is reconciled, what happens on an ordinary Tuesday. That is operational due diligence, and it is where most of the surprises actually live.</p>
  <p>Then ask a question that has nothing to do with him: who counts the money? If your friend tallies his own cash drawer and reports the total, the returns are not verified, they are asserted. A neutral bookkeeper is not a formality; it is the difference between a number and someone's word.</p>
  <p>Then ask what happens when things go ordinarily wrong. He gets ill. The shop has a slow month. Is there a cushion, and is there anyone who could run the place without him?</p>
  <p>And finally, does the story hold together? Returns that are wonderful in every market are not evidence of skill, they are a question. Especially if he is quietly buying the same stock for himself that he is buying for you.</p>
  <p>That is what due diligence on a hedge fund manager is: the same trust-but-verify list, run systematically, because a good pitch and a rising return chart are claims, not evidence.</p>`,
  ...
  <p>This material is asked less by reciting the eight failure reasons from memory than through a SCENARIO. A fund manager valuing their own illiquid book, a firm with high fees justified by vague "alpha," a compliance manual nobody has audited, and asking you to identify which due diligence category (business model risk vs. fraud risk; documents vs. actual verification; strategy vs. track record) the red flag belongs to, or what the correct follow-up action is. Expect distractor answers that sound reasonable but violate the independence principle (e.g., "the fund manager's own valuation is fine as long as it's done regularly") or that confuse business-model sustainability questions with fraud-detection questions.</p>`,
  ...
  concepts: [
    ...
    },
    {
      ...
      def: "What an investor checks when judging whether a manager's risk process is real rather than declared. It spans the risk framework itself, portfolio leverage and liquidity, the fund's tail-risk and stress practices, and the independence of valuation, each broken out in the breakdown below. The organizing question throughout is the same one: is this control exercised by someone with an incentive to report a problem, or by the person who would be blamed for it?",
    ...
    },
    {
      ...
      def: "The non-investment half of due diligence, where most fund failures actually originate. It has three focus areas, set out in the breakdown below: internal controls, documents and disclosure, and service providers. The recurring test is independence. A control the manager grades himself, a valuation the manager produces, and an administrator the manager selects and pays are each a single point of failure dressed as a safeguard.",
  ...
  highYield: [
    ...
    { stars: 3, what: "Policy documents (intention only) vs. independent audit of control effectiveness (actual verification).", why: "A precise distinction, frequently tested distinction about the LIMITS of documentary evidence." },
