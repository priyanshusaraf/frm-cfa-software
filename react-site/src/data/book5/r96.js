export default ({
  ...
  concepts: [
    ...
    },
    {
      ...
      def: "The seven properties an AI system needs before anyone should rely on its output, set out in the breakdown below. Valid and reliable is the foundational one, since a system that does not work correctly cannot be safe, fair or accountable no matter what else is bolted on. The three that get confused with each other are transparency (WHAT the system did), explainability (HOW it did it) and interpretability (WHY that output means what it means in context).",
    ...
    },
    {
      ...
      def: "The four functions of the AI Risk Management Framework, detailed in the breakdown below. Govern is not the first of four sequential steps: it is pervasive, running across map, measure and manage and continuing through the whole system lifecycle. That is the point most likely to be simplified into a strict ordering, which the framework explicitly does not impose.",
      ...
      related: [{ r: 95, label: "R95: the practical XAI and fairness tools that operationalize the measure and manage functions" }],
  ...
  quiz: [
    ...
    {
      q: "Which of the following is NOT one of the named risk measurement challenges specific to AI systems?",
      options: [
