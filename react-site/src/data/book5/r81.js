export default ({
  ...
  concepts: [
    ...
    },
    {
      ...
      def: "The capital asset pricing model (CAPM) describes an asset not in isolation but relative to the market: the relevant risk measure is the asset's covariance with the market portfolio, and risk premiums are set entirely by beta. Its six lessons are in the breakdown below, and they read as a chain rather than six separate facts. Because everyone optimizes identically the only portfolio worth holding is the market one; because the average investor already holds it, your own optimal exposure depends on how you differ from average; and because only undiversifiable risk can be rewarded, beta is the only thing you are paid for bearing.",
    ...
    },
    {
      ...
      pitfall: "The CAPM assumes NO taxes/transaction costs (not 'uniform' taxes/costs). A subtle wording distinction, and the kind of thing a distractor is built from.",
