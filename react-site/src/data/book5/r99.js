export default ({
  ...
  teaches: `<p>The Basel Committee's 18 principles for managing and supervising climate-related financial risk: 12 principles aimed at banks (governance, internal controls, capital/liquidity adequacy, risk management process, monitoring/reporting, credit/market/liquidity/operational risk management, and scenario analysis) and 6 principles aimed at supervisors (assessing bank governance and risk management, and exercising their own supervisory powers/techniques/resources).</p>`,

  why: `<p>This is the governance capstone of the climate-risk trilogy (R97 drivers → R98 measurement → R99 management/supervision). It is explicitly described as 'general in nature'. The exam focus line says to focus on understanding the principles, which signals matching/identification-style questions rather than calculation.</p>
  <p>Because there are 18 numbered principles, the exam favors 'which principle number covers X' and 'which line of defense handles Y' style questions.</p>`,

  intuition: `<p>Think of this reading as answering: if R98 gave you the measurement tools, who in the bank is responsible for using them, and how does a regulator check that they did? The 12 bank principles map cleanly onto a standard risk-management skeleton you've seen all book: governance (who decides) → internal controls (three lines of defense) → capital/liquidity adequacy (does this get baked into capital planning) → risk management process (day-to-day identification/monitoring) → reporting (does the board see it) → risk-type-by-risk-type application (credit, market, liquidity, operational) → scenario analysis (stress-test it). The 6 supervisor principles are just the mirror image: supervisors check that banks did all of the above, then use their own powers/resources/scenario tools to verify independently.</p>`,
  ...
  concepts: [
    ...
    },
    {
      ...
      example: "The third line of defense covers risk assessments (by reviewing the first line), internal audit AND data quality. All three, not any subset, which is the trap: each one alone reads as a complete answer.",
    ...
    },
    {
      ...
      example: "The risk type most directly associated with climate-related financial risk is CONCENTRATION risk, not counterparty, default or liquidity risk, because climate risk clusters by sector/geography in a way that concentration risk captures directly.",
    ...
    },
    {
      ...
      def: "Principles 7 through 11, the cluster that turns climate governance into day-to-day risk management. Principle 7 covers risk data aggregation and internal reporting; 8 through 11 then work through credit, market, liquidity, and operational and other risk in turn. The breakdown below gives each. What links them is that none introduces a new risk TYPE: climate is treated as a driver flowing into the risk categories a bank already manages.",
      ...
      example: "The credit-risk mitigation action LEAST likely to help is long-term lending. Banks reduce climate credit risk with SHORTER-term loans, not longer ones; targeting specific (higher-quality) clients, using discounted asset valuations, and lowering debt-equity covenant ratios all correctly reduce credit risk.",
    ...
    },
    {
      ...
      example: "Supervisors should focus MORE on stress testing and scenario analysis for larger banks than for smaller ones. not ensure assessments are purely internal (some specialist work is properly outsourced), not focus narrowly on quantitative specialists alone (a broad/diverse stakeholder group is needed, including climate scientists), and use STRESS TESTING (not sensitivity analysis) specifically to assess financial-position sufficiency under severe-but-possible scenarios.",
  ...
  misconceptions: [
    ...
    { wrong: "This reading includes calculation-heavy, quantitative exam questions similar to R98.", right: "This material is general in nature, so questions identify principles (which principle covers X, which line of defense owns Y) rather than asking for a calculation." }
  ],
