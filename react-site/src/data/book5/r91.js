export default ({
  ...
  concepts: [
    ...
    },
    {
      ...
      def: "The disclosures every registered adviser already files on Form ADV, read as fraud predictors. The point of the study is that intuition is a poor guide to which ones matter: several disclosures that look like glaring conflicts (soft dollar arrangements, serving as custodian, majority employee ownership) carry no significant fraud signal, while others cut in a direction nobody would guess, notably registration under the Investment Company Act, which predicts MORE theft while reducing misrepresentation. The full variable list, with the exact direction of each, is in the breakdown below, and the direction is the whole content: a variable with the sign flipped is simply the wrong answer.",
  ...
  highYield: [
    ...
    { stars: 4, what: "Theft vs. fraudulent misrepresentation: which variables predict which type.", why: "A precise two-category split. Frequently tested via scenario matching." },
