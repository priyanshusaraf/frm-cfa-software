export default ({
  ...
  highYield: [
    ...
    { stars: 3, what: "Transaction costs occurring at a point in time vs. benefits accruing over time: the amortization/horizon problem.", why: "A subtle but consequential timing mismatch, and it is what makes the cost-benefit comparison harder than it looks." },
