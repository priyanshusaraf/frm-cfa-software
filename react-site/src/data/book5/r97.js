export default ({
  ...
  concepts: [
    ...
    },
    {
      ...
      def: "Conditions that make a given climate risk driver hit harder than it would alone. The full set is in the breakdown below. The one worth internalizing is interaction: physical and transition effects arriving together (an extreme weather event during an abrupt policy shift, say) do more damage than either would separately, because the same balance sheet absorbs both at once.",
    ...
    },
    {
      ...
      def: "Offsets that reduce the financial impact of a climate risk driver, split first by timing: proactive ones act before the event (diversification, adaptation investment) and reactive ones after it (hedging, insurance). The four categories and their specific mechanisms are in the breakdown below. The recurring caution is that a mitigant is only as good as the counterparty behind it, so insurance concentrates risk rather than removing it if the insurer is exposed to the same event.",
  ...
  quiz: [
    ...
    {
      q: "Which of the following is one of the four transition risk drivers?",
      options: [
        "Rising sea levels",
    ...
    {
      q: "Insurance covered roughly what share of global natural-disaster economic losses in 2019, and how does developing-nation coverage compare?",
      options: [
    ...
    {
      q: "Which of the following provides SHORT-TERM (rather than long-term) resilience to climate risk for a sovereign or economy.",
      options: [
