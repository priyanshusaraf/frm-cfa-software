export default ({
  ...
  intuition: `<p>You can outsource the ACTIVITY. You cannot outsource the ACCOUNTABILITY. Regulators hold the outsourcing bank responsible for the outcome no matter whose staff performed the work, and the six-part program (assess, diligence, contract, incentive review, monitor, continuity plan) exists because of that single fact.</p><p>Those six parts sit on a chain with three links, sorted by when they happen.</p><p><strong>Before</strong> you sign anything, the risk assessment asks whether this should leave the building at all and who could plausibly do it. Due diligence then examines the specific candidate vendor.</p><p><strong>At the moment</strong> you sign, the contract turns every risk you identified into an enforceable clause. Nothing you merely assumed survives this step.</p><p><strong>After</strong> you sign come incentive-compensation review, ongoing oversight and monitoring, and a continuity plan for the day the vendor itself fails.</p><p>Miss any one link and the chain does not hold. Skip the "before" and you outsource something that should never have left, or hire a vendor nobody vetted. Skip the signing and even a well-chosen vendor has no enforceable obligation to do the things you took for granted. Skip the "after" and a vendor that looked fine on day one degrades quietly for years before anyone notices.</p>`,
  ...
  concepts: [
    {
      ...
      pitfall: "Compliance risk specifically means the SERVICE PROVIDER failing to comply with laws and regulations relevant to the outsourced activity. It is not simply \"any regulatory risk.\" Don't confuse it with legal risk (lawsuits/costs from the provider's negligent acts) or operational risk (losses from the provider's internal control breaches and human error).",
    ...
    },
    {
      ...
      pitfall: "This is a LONG, testable list, and the standard question asks which specific clause addresses a described scenario (e.g., 'what if the provider itself subcontracts the work further' → subcontracting rights clause). A commonly tested distinction: performance metrics and standards ('establishment and monitoring of performance standards') differ from 'right to audit'. Metrics define what \"good performance\" measurably looks like, while audit rights let the bank verify compliance and obtain reports.",
      related: [],
      memory: "The contract is where accountability gets written down in enforceable detail, and every risk in the six-category list should map to a specific clause."
    }
  ],
  ...
  highYield: [
    ...
    { stars: 3, what: "Contract provisions list, especially audit rights, subcontracting rights, and business resumption planning.", why: "Questions here hand you a described contractual gap and ask which clause closes it." },
  ...
  quiz: [
    ...
    },
    {
      ...
      answer: 2,
      why: "The program must provide adequate oversight and controls proportional to an activity's impact on the institution, which is the core design principle. The 'focus primarily on business continuity' answer wrongly elevates one of six equally weighted elements. The 'more detail for few activities to established, reliable providers' answer inverts the actual rule: depth/complexity should be LOWER, not higher, when there are few outsourced activities to established, reliable providers. The 'risk mitigation techniques, not risk assessments, should be updated' answer reverses the causality: risk assessments are updated as a result of updated risk MITIGATION techniques, and mitigation techniques themselves flow from ongoing risk assessments; the program requires both to stay current, not one instead of the other."
    },
    {
    ...
    {
      q: "Which of the following is NOT one of the contract provisions the Federal Reserve's outsourcing guidance expects a financial institution to negotiate?",
      options: [
        "Establishment and monitoring of performance standards",
        "An exclusivity clause barring the provider from serving competing institutions",
        "Indemnification for the provider's negligence",
        "A cap on the provider's liability, subject to board approval"
      ],
      answer: 1,
      why: "Performance standards, indemnification, and limits on liability are all named provisions in the guidance. Exclusivity is not: the guidance is about controlling the institution's own exposure to the provider, not about restricting who else the provider serves, and demanding exclusivity would in any case worsen concentration risk rather than reduce it."
    },
    {
