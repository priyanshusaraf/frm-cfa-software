export default ({
  ...
  concepts: [
    ...
    },
    {
      ...
      def: "Validation splits into six qualitative processes and six quantitative ones, and the split matters because they answer different questions. The qualitative side asks whether the model is sound and actually used: the use test, qualitative review, systems implementation testing, management oversight, data quality checks, and assumption or sensitivity testing. The quantitative side asks whether the numbers hold up: input and parameter validation, model replication, benchmarking against hypothetical portfolios, backtesting, stress testing, and analysis of the model's own sensitivity to its parameters.",
    ...
    },
    {
      ...
      def: "Ten BIS recommendations for supervisors making use of banks' internal risk measures, running from how economic capital models feed a capital-adequacy judgment through to interest rate risk in the banking book. They cluster into three concerns: whether senior management genuinely owns the framework (recommendations 1 to 3), whether the measurement itself is trustworthy (risk identification, risk measures, aggregation, and validation, recommendations 4 to 7), and whether the hardest risk types are handled honestly rather than assumed away (credit dependency modeling, counterparty credit risk, and IRRBB, recommendations 8 to 10).",
    ...
    },
    {
      ...
      def: "Governance is what decides whether an economic capital framework changes decisions or just produces reports. Four practices carry it: senior management commitment, clear business-unit involvement and expertise (which can be centralized in one function such as Treasury, or decentralized across finance and risk), a defined timing for measurement and disclosure, and written policies for owning, developing, validating, and monitoring the models under a named model owner.",
  ...
  highYield: [
    ...
    { stars: 2, what: "The 10 BIS recommendations and the 4 governance best practices / 6 governance concerns.", why: "Long enumerable lists, which is exactly what 'which of the following is NOT one of the...' questions are built from." }
  ],
  ...
  breakdown: [
    ...
    {
      title: "Risk aggregation methodologies",
      points: [
    ...
    {
      title: "Qualitative model validation processes",
      points: [
    ...
    {
      title: "Quantitative model validation processes",
      points: [
