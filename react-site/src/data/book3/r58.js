export default ({
  ...
  concepts: [
    ...
    },
    {
      ...
      pitfall: "Don't confuse capital policy with governance policy: dividend/repurchase suspension rules are a capital-policy matter, not a governance-policy matter, and mixing the two up is the standard trap here."
    },
    {
  ...
  eli5: `<p>A company runs a large car-rental fleet. The state inspector does not just want to know it can handle normal driving. It wants proof the fleet could survive a serious pile-up and still put cars on the road for customers the next morning.</p>
  <p>Crucially, "we ran the numbers and we're fine" is not proof. The fleet's own mechanics grading their own work is not proof either. The inspector wants to see the working.</p>
  <p>So it asks, in order. How did you identify every way a car could break down in the first place? What would you have left afterwards, in working cars, cash and spare parts? How much would you lose? Is what remains actually enough? What is your policy for repairs and replacement priorities, decided in advance rather than in the moment?</p>
  <p>Then two questions about the process itself rather than the fleet. Did somebody independent check the arithmetic? And did the board of directors genuinely understand this plan and sign it, or did they receive a summary and nod?</p>
  <p>Those last two matter more than they look. A perfect estimate that nobody independent verified, and a perfect plan the board never really read, are both just paperwork.</p>
  <p>Map it back: the fleet is a large bank holding company, the pile-up is the Fed's stress scenario, and those seven checkpoints are the seven CAP principles under the Federal Reserve's Capital Plan Rule.</p>`,
  ...
  breakdown: [
    ...
    {
      title: "Key practices for a strong CAP (Module 59.2)",
      points: [
    ...
    {
      title: "Approaches to counterparty credit risk (CCR) estimation",
      points: [
    ...
    {
      title: "Approaches to credit loss estimation",
      points: [
