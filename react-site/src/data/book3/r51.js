export default ({
  ...
  tagline: "Extends R50's outsourcing framework into full TPRM, including fourth- and fifth-party exposures (your vendor's vendors), anchored by the Capital One and Morgan Stanley failures.",
  ...
  <p>Picture the supply chain as a series of links you can see progressively less of. Your <strong>third party</strong> is the vendor you signed a contract with: you can audit them, you can read their SLA, you know their name. Their <strong>fourth party</strong> is a subcontractor <em>they</em> hired to help deliver the service to you, a firm you likely never negotiated anything with and may not even know exists. A <strong>fifth party</strong> is one layer further still, a contractor working for your vendor's subcontractor. For how unglamorous the entry point can be: the self-service convenience company Avanti Markets was hacked <em>through its vending machines</em>, an Internet of Things (IoT) device most people would never think of as an attack surface. The point isn't that vending machines are dangerous. It's that risk enters through whatever component in the chain has the weakest control, and that component is often several layers removed from where you're looking.</p>`,

  formulas: [],

  concepts: [
    {
      name: "TPRM lifecycle, start to finish",
      def: "(1) Business model decision: what should even be outsourced. (2) Evaluation, risk rating, due diligence: proportional to the relationship's complexity and length. (3) Contracts, SLAs, contract management: periodically reviewed. (4) Ongoing monitoring: reassessment triggers defined in advance. (5) Remediation or termination: grievance period, exit and termination clause.",
      intuition: "Read it as a relationship's full life, not a one-time gate: you decide whether to outsource at all, vet the specific partner, formalize the deal in writing, keep watching the relationship after signing, and eventually wind it down cleanly, on your terms rather than the vendor's.",
      example: "Stage 1, business model decision: the firm decides its call-center function is a good candidate for outsourcing but core underwriting decisions are not, and that call depends on the firm's risk appetite, not just on cost. Stage 2, due diligence is proportional: a long-term cloud hosting vendor (like AWS for Capital One) gets deep diligence into financial condition, operations, and internal controls; a consultant running a one-day training session gets a light-touch check. Stage 3, contracts: before signing, best practice is to assess and remediate all open issues first, then review the contract periodically afterward. Contract management got real teeth during COVID-19, when U.S. and European firms with offshore call centers in India and the Philippines had to renegotiate contracts to let third-party staff work fully remote. Stage 4, ongoing monitoring: reassessment triggers include not just calendar dates but data breaches, regulatory changes, M&A activity, and, a lesson COVID-19 taught the industry, 'acts of God' (natural, unavoidable disruptions). Stage 5, remediation or termination: contracts should include a grievance period and a clean exit/termination clause, plus a well-defined process for transferring intellectual property back in-house when the relationship ends.",
    ...
    },
    {
      ...
      example: "A bank contracts a payroll vendor (third party). That payroll vendor outsources its data-hosting to a cloud provider (fourth party from the bank's perspective). If that cloud provider uses a specialized subcontractor for physical data-center security (fifth party), the bank likely has zero direct contractual relationship with that fifth party, and no visibility into it, yet a breach originating there is still the bank's problem.",
      pitfall: "Visibility into sub-outsourcing relationships is exactly the third-party cyber risk dimension named in R47, so the concern isn't hypothetical: it's a recurring named risk category. Firms should build limits on outsourcing to fourth parties and secure audit rights over vendors as part of continuous monitoring, precisely because visibility does not happen automatically.",
    ...
    },
    {
      ...
      def: "The single lesson both the Capital One and Morgan Stanley cases teach: even when the underlying FUNCTION can be outsourced, accountability for the outcome cannot.",
      ...
      pitfall: "A vendor's failure is STILL the bank's regulatory and reputational problem, which is the single most important takeaway of the reading and worth memorizing as a standalone principle. Any answer that assigns the fine or the ultimate accountability to the vendor, the subcontractor, or a 'shared' split is wrong: the OCC fined the banks, not AWS or the hardware-disposal contractor.",
  ...
  connections: {
    ...
    to: [],
    confused: [
      { what: "Third-party vs fourth-party vs fifth-party risk", how: "Third-party is your direct vendor; fourth-party is your vendor's vendor; fifth-party goes one layer further. Visibility gets progressively harder to maintain at each remove, while accountability does not move at all." },
  ...
  highYield: [
    ...
    { stars: 3, what: "TPRM five-stage lifecycle.", why: "A clean process framework, good for 'which step comes first' and 'which stage does this belong to' questions." },
    ...
    { stars: 2, what: "Capital One and Morgan Stanley case specifics: dollar fines, regulator (OCC), and the specific control failures named.", why: "Case studies are tested on the concrete facts (who, how much, what specifically failed), not just the abstract lesson, so expect to match a fine amount or failure type to the right bank." }
  ],
  ...
  <p>Two question shapes recur. One is stage placement: given a TPRM activity ("establishing limits on fourth-party outsourcing", say), name which of the five lifecycle stages it belongs to. The answer is contracts, SLAs, and contract management, because limits get formalized as contractual terms rather than evaluated as a separate step. The other is case-study detail, testing whether the "accountability cannot be outsourced" conclusion stuck and whether the details attach to the right bank: regulator OCC, fines of $80M for Capital One and $60M for Morgan Stanley, cloud data breach versus hardware decommissioning.</p>`,
  ...
  breakdown: [
    ...
    },
    {
      ...
      points: [
        ...
        "Shared conclusion: certain FUNCTIONS can be transferred to third parties, but ultimate accountability is not transferable, and both banks, not their vendors, were the ones fined."
      ]
    },
    {
  ...
  quiz: [
    ...
    },
    {
      ...
      answer: 1,
      why: "The OCC fined Capital One $80 million in 2020 for failing to identify and manage vendor risk ahead of the 2019 breach. $60 million in 2020 is the Morgan Stanley fine, and swapping the two banks' numbers is the classic mix-up here."
    },
    {
