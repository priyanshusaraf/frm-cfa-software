export default ({
  ...
  tagline: "AML/CFT is the three-lines-of-defense model applied to knowing your customer well enough to stop criminal money, anchored by the $140 million 2022 USAA fine, which was for weak controls rather than proven theft.",

  teaches: `<p>This reading builds a precise vocabulary for financial crime, then tests it against one real case. You will learn: the umbrella definition of <strong>financial crime</strong> (fraud, money laundering, and terrorism financing together); the exact Basel Committee definitions of <strong>internal fraud</strong> and <strong>external fraud</strong>, including their sub-categories; the <strong>three lines of defense</strong> as applied specifically to anti-money-laundering / countering the financing of terrorism (AML/CFT), not just operational risk in general; the <strong>customer due-diligence (CDD)</strong> factors and identification documents banks must collect under FATF standards; how a <strong>cross-border banking group</strong> must run AML/CFT consistently across jurisdictions; money laundering's <strong>three phases</strong> (placement, layering, integration) with the actual techniques criminals use at each step, "smurfing" among them; the shared <strong>four-control framework</strong> (selection, prevention, detection, deterrents) that both fraud and AML programs are built from; and the <strong>USAA Federal Savings Bank</strong> case: a $140 million fine from FinCEN and the OCC, imposed for control failures with no proven theft.</p>`,

  why: `<p>The USAA case is the cleanest illustration in the book that regulatory penalties can follow from CONTROL DEFICIENCIES ALONE: no proven theft or loss is required. This matters because it recalibrates how you should think about "is our AML program good enough": the bar is control adequacy, not just absence of losses. It also matters because the trap answers here assume a fine must trace to an actual criminal event. Knowing the USAA facts cold (five years of gaps, an overwhelmed alert system, understaffed review) is what lets you eliminate those traps confidently rather than by guessing.</p>`,
  ...
  concepts: [
    ...
    },
    {
      ...
      example: "Enhanced due diligence is specifically required for accounts with large balances plus regular cross-border wire transfers, and for politically exposed persons (PEPs), especially foreign PEPs, because their public profile and access to public funds raises corruption and bribery risk.",
      related: []
    },
    {
    ...
    },
    {
      ...
      example: "Concretely: due to staffing shortages the bank used third-party contractors to monitor accounts but failed to adequately train them in AML compliance; a new transaction-monitoring system introduced in 2021 was overly sensitive and generated far more alerts than staff could review, so by year-end 2021 there were close to 90,000 unreviewed alerts and nearly 7,000 unreviewed cases. Following sanctions like these, firms typically run AML remediation programs, or 'lookbacks', reviewing client information and re-reporting suspicious activity.",
      pitfall: "The USAA fine is a clean example that regulatory penalties can follow from CONTROL DEFICIENCIES ALONE, with no proven theft or loss event required. Don't assume a regulatory fine implies an actual quantifiable loss occurred; the fine was for the program being inadequate, not for any specific case of fraud or laundering being proven.",
      related: [],
  ...
  connections: {
    ...
    confused: [
      ...
      { what: "Regulatory fine vs proven loss event", how: "A fine like USAA's can result purely from CONTROL DEFICIENCIES, with no proven theft, fraud, or quantifiable loss required for a bank to be penalized." },
  ...
  misconceptions: [
    { wrong: "\"A bank can only be fined for AML failures if a specific instance of money laundering is proven.\"", right: "USAA was fined for failing to meet BSA/AML minimum standards and for inadequate suspicious-activity monitoring. CONTROL DEFICIENCIES ALONE were sufficient grounds for the penalty, with no specific proven theft or laundering event required." },
    ...
    { wrong: "\"USAA's fine was primarily about a specific fraud loss that occurred in 2021.\"", right: "The regulators' findings centered on a persistent, multi-year (2016-2021) deficiency in AML controls, namely an overwhelmed alert system and undertrained contractors, not on any single proven theft, fraud, or laundering loss." },
  ...
  highYield: [
    ...
    { stars: 3, what: "Enhanced due diligence triggers: large-balance cross-border wire accounts and politically exposed persons (PEPs).", why: "A specific, testable pair of trigger conditions, usually presented as a scenario." },
    ...
    { stars: 2, what: "Four-control framework: selection → prevention → detection → deterrents.", why: "Reused across internal fraud, external fraud, and AML, so recognizing the shared shape saves memorization effort." }
  ],
  ...
  quiz: [
    {
      ...
      answer: 1,
      why: "USAA was fined for control deficiencies alone: an ineffective, under-resourced AML program (2016-2021) that didn't meet BSA/AML minimum standards, evidenced by tens of thousands of unreviewed alerts. The 'confirmed $140 million money laundering case' answer is the classic trap: it assumes a proven loss event, which was NOT the basis for the fine. The 'cybersecurity breach' answer confuses this case with a cyber-risk case study (a different reading). The 'never appointed a chief AML/CFT officer' answer is factually wrong: USAA had AML processes and even a monitoring system, and they were simply inadequate."
    },
    {
    ...
    },
    {
      ...
      answer: 2,
      why: "Selection is about screening who you let into the relationship in the first place, and for AML that is exactly what KYC does: verify identity and the legitimate origin of funds before or as the account relationship begins. Prevention is about controls that operate once the relationship exists (segregation of duties, risk-based tiering); detection is ongoing monitoring for abnormal activity; deterrents are the consequences imposed after something is caught."
    },
    {
      q: "A U.S. banking group's branch operates in a host country whose AML/CFT rules are stricter than the group's home-country standards. What should the branch do?",
      options: [
  ...
  sources: [
    { title: "Financial Crimes Enforcement Network (FinCEN)", url: "https://www.fincen.gov/", note: "The U.S. Treasury bureau that, alongside the OCC, fined USAA FSB. Its enforcement actions page carries the BSA/AML case details." },
