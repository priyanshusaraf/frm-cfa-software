export default ({
  ...
  concepts: [
    {
      ...
      def: "Risk capital is the buffer a firm holds specifically to absorb unexpected losses, the protection that assures depositors, counterparties, and other stakeholders their funds are safe even if a bad year hits. Economic capital is risk capital plus strategic risk capital, a broader definition used for capital budgeting. Regulatory capital is a different animal entirely: a minimum floor set by industry-wide formula for regulated firms, computed by a process that has no reason to agree with what any specific portfolio actually needs.",
    ...
    },
    {
      ...
      def: "Four linked reasons financial institutions lean on economic capital rather than leaving capital to a regulatory formula: capital is what cushions risk in a business that can lever up cheaply through deposits and debt; the institution has to be visibly creditworthy to the same people who fund it; outsiders cannot easily assess that creditworthiness because a bank's risk profile can shift within days; and capital is expensive, so how much of it each activity consumes drives profitability directly.",
    ...
    },
    {
      ...
      def: "RAROC beats plain accounting profit on four fronts: it measures performance in economic rather than accounting terms, it feeds incentive compensation at firm and divisional level, it supports portfolio and capital decisions by pricing the incremental value of adding or dropping an activity, and it enables risk-based pricing, since a transaction's price has to cover both its expected loss and the cost of the economic capital it ties up.",
    ...
    },
    {
      ...
      def: "Three inputs a firm must choose before RAROC produces any number, and each is a judgment rather than an observation. Time horizon: usually one year, because that fits the planning cycle and roughly matches recovery time from a significant loss. Default probability: point-in-time for short-term pricing, through-the-cycle for capital and strategy. Confidence level: set to match the firm's target credit rating, so an AA or AAA target needs better than 99.95%.",
      example: "Daily VaR=80, core risk=60, 10 days to reduce (2/day), 252 business days: annualized VaR = \\(80\\times \\sqrt{252}\\) ≈ 1,269.96. Required risk capital is about 75.6% of annualized VaR (≈960.18/1,269.96). This blends the gradual reduction path (from current risk down to the core level, at 2 VaR/day) with the fact that a residual 'core' risk level persists for the rest of the year regardless of how quickly the firm de-risks. Separately: with four risk types (market $400, credit $300, liquidity $200, operational $500) aggregate risk capital could be as high as $1,400 assuming perfect (+1) correlation (simple sum) or as low as $734 assuming zero correlation (square root of the sum of squares: \\(\\sqrt{400^2+300^2+200^2+500^2}\\)). The true figure lies somewhere in that wide $734 to $1,400 range, and pinning it down (plus fairly allocating the resulting diversification benefit back to business units) is genuinely difficult in practice.",
    ...
    },
    {
      ...
      def: "Six practices that decide whether a RAROC framework actually changes behaviour or just produces numbers: senior management buy-in, communication and education across business units, ongoing consultation through a metrics-review committee, data quality control owned by a central team, a qualitative complement to the pure ratio, and active capital management through regular limit reviews.",
      related: []
    }
  ],
  ...
  thinkLike: `<p>A risk manager reviewing a new loan, trading desk, or acquisition doesn't start with "how much profit will this make". They start with "how much capital will this tie up if things go badly, and does the expected return clear the bar for THAT much capital." That reframing is the whole point of RAROC: profit and risk only mean something together, never separately. When comparing two business units with different RAROCs, a sharp practitioner immediately asks a second question before declaring a winner: is the higher-RAROC unit higher-RAROC because it's genuinely more efficient, or just because it's taking on more systematic (market-correlated) risk that RAROC alone doesn't price? That's exactly the gap ARAROC is built to close, and it is the favourite trap here: a scenario where RAROC clears the hurdle rate but ARAROC, once you subtract the CAPM-based systematic risk toll, does not clear the risk-free rate.</p>
  ...
  breakdown: [
    {
      title: "Risk capital, economic capital, and regulatory capital: three concrete differences",
      points: [
        "Regulatory capital applies only to regulated industries such as banking and insurance. A manufacturer has no regulatory capital requirement at all.",
        "Regulatory capital is set by industry-wide benchmarks, formulas applied across all similar firms, and usually sits well below a specific firm's true, firm-tailored risk capital need.",
        "Within a firm's own divisions, risk capital and regulatory capital can diverge even when the two happen to match at the whole-firm level: a low-risk-capital division can still face a high regulatory charge, or the reverse.",
        "Allocate the GREATER of risk capital and regulatory capital per division, and compute risk capital even where the regulatory number is higher, because only the risk number tells you whether the activity is worth doing."
      ]
    },
    {
      title: "Why financial institutions use economic capital at all",
      points: [
        "Capital cushions risk: unlike most non-financial firms, banks lever up cheaply through deposits and debt with no equity issuance required, and their derivatives, guarantees, and commitments carry real risk on little upfront funding, so every activity needs a capital cost attached.",
        "They must be creditworthy to their own funders: a bank's depositors are also its main liability holders, and OTC derivatives counterparties care about counterparty risk the same way, so holding enough economic capital reassures both.",
        "Outsiders cannot easily assess that creditworthiness, because complex hedging and derivatives positions can change a bank's risk profile and liquidity quickly. A strong capital buffer substitutes for the missing external clarity.",
        "Capital is expensive: economic capital behaves like equity (it is not repaid the way debt is, and it absorbs losses), so a firm balances holding enough of it against the drag it puts on returns."
      ]
    },
    {
      title: "Benefits of RAROC over plain accounting profit",
      points: [
    ...
    {
      title: "Judgment calls that make RAROC hard to apply",
      points: [
    ...
    {
      title: "Capital concepts for diversification benefit",
      points: [
  ...
  connections: {
    ...
    confused: [
      ...
      { what: "Stand-alone vs fully diversified vs marginal capital", how: "Stand-alone: each activity's OWN capital need in isolation. Fully diversified: total combined capital, allocated pro-rata (accounts for diversification benefit). Marginal: the capital added by ONE activity given the other already exists (marginal amounts sum to less than the total, which is expected rather than an error)." },
